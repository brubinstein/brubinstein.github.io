...
I have contributed submissions to a range of policy and legislation consultations and inquiries run by government departments and agencies. These responses highlight challenges and best-practice solutions in data privacy and AI.
...
for (i in seq(from=1,to=nrow(SUBS))) {
  ...
  cat(" in response to ")
  cat("[", SUBS[i,"Consultation"], "](", SUBS[i,"URL"], "), ", SUBS[i,"Organisation"], sep="")
  cat(", ", SUBS[i,"Date"], ".", sep="")
}
```
