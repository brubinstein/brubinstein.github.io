...
_Media coverage:_ [9news](http://www.9news.com.au/health/2017/01/12/12/11/matchmaking-approach-to-liver-transplants), [heraldsun](http://www.heraldsun.com.au/news/victoria/how-dating-site-eharmony-can-help-boost-liver-transplant-success/news-story/eaaf4cc3c859dbd5c38baed5c2b496b0)
...
_Media coverage (2016):_ [zdnet](http://www.zdnet.com/article/brandis-swings-his-golden-hammer-misses-mark/) ([again](http://www.zdnet.com/article/brandis-re-identification-law-proposal-slammed/)),
...
_Media coverage (2017 exceeding 1m views):_ 
...
Since arriving at the University of Melbourne Oct 2013, I have been awarded **\$3.2m total** in competitive funding (Cat 1--4), **\$2.0m as lead-CI**, \$1.2m on a per-CI basis. Funding includes:

* 2017--20 **\$1.05m: [Defence Science & Technology Group](https://www.dst.defence.gov.au/) and [Data61](https://www.data61.csiro.au/)** CRP _Adversarial Machine Learning for Cyber_ lead-CI (with Tansu Alpcan, Sarah Erfani, Chris Leckie - UoM, Jun Zhang - Swinburne) projected with renewal.
* 2017--21 **\$970k: [Department of Education and Training](https://www.education.gov.au/)** [_Academic Centre for Cyber Security Excellence (ACCSE)_](https://www.education.gov.au/academic-centres-cyber-security-excellence-accse) co-CI (with Chris Leckie, Atif Ahmad, Rao Kotagiri, Udaya Parampalli, Shanika Karunasekera, Vanessa Teague, Tansu Alpcan, Tim McCormack, Marimuthu Palaniswami)
* 2017--18 **\$93k: [Defence Science & Technology Group](https://www.dst.defence.gov.au/)** _Tactical Security and Health in Multi-Modal Sensor Control and Management_ with Iman Shames and Farokhii.
* 2017--18 **\$24k: [Australia Bureau of Statistics](http://www.abs.gov.au/)**, ABS/AMSI internship program, _Evaluating feasibility of Bayesian entity resolution_ with Neil Marchant.
* 2017 **\$168k: [Australian Bureau of Statistics](http://www.abs.gov.au/)**, Research Contract on _Design of securely encrypted (anonymised) linkage keys_ with Chris Culnane and Vanessa Teague.
* 2016--18 **\$370k:** [**Australian Research Council** Discovery Early Career Researcher Award](https://rms.arc.gov.au/RMS/Report/Download/Report/a3f6be6e-33f7-4fb5-98a6-7526aaa184cf/6) _Secure and Private Machine Learning_ (as sole-CI fellow) Cat1 with additional \$85k University of Melbourne DECRA establishment grant.
* 2015 **\$48k: [Melbourne Networked Society Institute](http://networkedsociety.unimelb.edu.au/)** [_Active Defence_](http://networkedsociety.unimelb.edu.au/research/projects/2015/active-defence.html) (with Atif Ahmad, Tansu Alpcan, Andre Gygax, Chris Leckie); media: [pursuit](https://pursuit.unimelb.edu.au/articles/can-hackers-turn-off-the-lights)
* 2015--16 **\$128k: Elon Musk-backed** [**FLI** Project Grant](http://futureoflife.org/misc/2015selection) for [_Security Evaluation of Machine Learning Systems_](http://futureoflife.org/misc/2015awardees#Rubinstein) (sole-CI) Cat3; media: [vice](http://www.vice.com/en_au/read/we-spoke-to-an-expert-protecting-us-against-artificial-intelligence) [news.com.au](http://mobile.news.com.au/technology/innovation/elon-musks-multimillion-dollar-plan-to-stop-robots-taking-control/story-fnjwucti-1227435849874) [pursuit](https://pursuit.unimelb.edu.au/articles/the-rise-of-the-machines-fact-or-fiction)
* 2015 **\$20k:** [**Microsoft Research** Azure Machine Learning Award](http://research.microsoft.com/en-us/projects/azure/ml.aspx) to support work on big data preparation
* 2015--17 **\$216k:** [**Australian Research Council** Discovery Project](http://www.arc.gov.au/ncgp/dp/dp_outcomes.htm) _Democratising Big Machine Learning_ (as sole-CI) Cat1
* 2014 **\$39k:** [**University of Melbourne** Early Career Researcher Grant](http://mro.unimelb.edu.au/content/early-career-researcher-grants) to support work on [adversarial machine learning](secml.html)
* 2014 **\$5k:** [**Amazon** AWS Machine Learning Grant](http://aws.amazon.com/grants/#25292) to support work on [adversarial machine learning](secml.html)
...
As member of the Australian Academy of Science's [National Committee for Information and Communication Sciences](https://www.science.org.au/supporting-science/national-committees-science/national-committee-information-and-communication) (2015--2020) contributing to the development of a Decadal plan for ICT.

### Program committee membership

* **ICML**['2011](http://www.icml-2011.org/),['12](http://icml.cc/2012/),['17](https://2017.icml.cc/),['18](https://2017.icml.cc/),['19 (area chair)](https://icml.cc/Conferences/2019), 
[**AAAI**'2018 (senior PC)](https://aaai.org/Conferences/AAAI/aaai18.php), 
**NeurIPS** (formerly NIPS)['2014](https://nips.cc/Conferences/2014),['17](https://nips.cc/Conferences/2017/),['18](https://nips.cc/Conferences/2018/),
...
* Workshop PCs: 
[Privacy Preserving Machine Learning (PPML) 2018](https://ppml-workshop.github.io/ppml/) (at NeurIPS), 
...
AI & Security (AISec at CCS)['2009](http://sites.google.com/a/aisec.info/aisec-2009/),['10](http://sites.google.com/a/aisec.info/aisec-2010/),['13](http://sites.google.com/site/ccsaisec2013/),['15](http://www-bcf.usc.edu/~aruneshs/AISec2015.html),['16](http://teamcore.usc.edu/people/arunesh/AISec2016.html),['17](http://www.ai-sec.net/AISec2017/index.html),['18](http://aisec2018.icsi.berkeley.edu/aisec2018/), 
